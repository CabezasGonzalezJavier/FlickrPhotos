...
Create an app to display an image gallery of the Flickr Public Feed.
Requirements
...
• Use a GitHub or Bitbucket git repo with public access
• You may use 3rd-party libraries
• Visual layout is at your discretion
Evaluation
We will evaluate your codebase and approach to development against a variety of aspects, including:
• Adherence to SOLID
• Coding standards
• Architecture
• Unit tests
